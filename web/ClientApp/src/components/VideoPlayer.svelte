<script>
    import {datachannel} from '../stores/stores'
    //export let stream;
    ...
    export const setCallbacks = (dc) => {
        ...
        window.addEventListener("keydown", (event) => {
            ...
            let input = {
                ...
                shiftKey : event.shiftKey,
                key : event.key,
                code : CodeToScanCode[event.code],
                repeat : event.repeat,
                type : event.type
            };
            dc.send(JSON.stringify(input));
    ...
    export const show = () => {
        const divElem = document.getElementById("media");
...
<div id="media" style="display: none;">
    ...
    <video id="videoplayer" autoplay playsinline style="background-color: aliceblue;">Loading...</video>
</div>
